...
UPDATE phone_calls SET caller_name = people.name FROM people
...
-- Below here it gives me an error in this area I can't figure it out. Anyone know why?
-- Parse error near line 45: row value misused

SELECT name FROM people
JOIN passengers ON people.passport_number = passengers.passport_number
JOIN flights ON flights.id = passengers.flight_id
WHERE (flights.year = 2021, flights.month = 7, flights.day = 29, flights.id = 36)
